...
import com.mywebrtc.util.YuvFormatTransform;
...
//  private int myVideoFormat=-1;
  ...
  private void startPreviewOnCameraThread(int width, int height, int framerate) {
	...
	// bruce add camera capture format  type to show 
	{
	 /* List<Integer>  parameterList=parameters.getSupportedPreviewFormats();
	  MyLog.printf(TAG,"00000000000000000000000000000000000000000 parameterList=%s",parameterList);
	  MyLog.printf(TAG, "...............ImageFormat   YV12=%d",ImageFormat.YV12);*/
	//	parameters.setPreviewFormat(ImageFormat.NV21);
    }
    
    camera.setParameters(parameters);
    
/*    myVideoFormat=parameters.getPreviewFormat();
    Log.e(TAG," @@@@@@@@@@getPreviewFormat:"+myVideoFormat);
  ...
  public void onPreviewFrame(byte[] data, android.hardware.Camera callbackCamera) {
    ...
    if (camera != callbackCamera) {
     ...
     // todo:   bruce add Thread.sleep(100);   at 2015.06.25
...
//	MyLog.printf(TAG,"...............................eeeeeeeeeeeeeee");

    // add  by bruce for NV21 format
/*    if (myVideoFormat==ImageFormat.NV21)
    	MyLog.printf(TAG,"...............................ImageFormat.NV21");
    else
    	MyLog.printf(TAG,"............!!!!!!!!!!!!!!!====ImageFormat.NV21");*/
 ...
 *     if (myVideoFormat==ImageFormat.NV21)
    {    	
        ...
        MyLog.printf(TAG,"...............................onPreviewFrame NV21");    	
        int w=callbackCamera.getParameters().getPictureSize().width;
        int h= callbackCamera.getParameters().getPictureSize().height;   
        
        if (i420bytes==null)
        	i420bytes=new byte[data.length];
    	  YuvFormatTransform.NV21ToYV12(data,i420bytes, w, h);//NV21ToI420(data, i420bytes, w,h);
		    System.arraycopy(i420bytes, 0, data, 0, data.length);       
		    
    }
    else
	MyLog.printf(TAG,"...............................fffffffffffffff"); 
*/   	   	   	   	
